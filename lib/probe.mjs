 ...
 * stale record from a current one. The obvious repair — keying the file by
 * `(base_url, model)` — is exactly the pair this rule forbids publishing, so the
 * two positions are not reconcilable and this one wins. A
