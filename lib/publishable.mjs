 ...
 * failed. So the row is kept when its name is published under *any* of the three
 * lists, and dropped otherwise. A row with no `name` is not entity-bound — it is
 * a whole-source failure — and `projectPublishable` keeps those without asking.
 */
