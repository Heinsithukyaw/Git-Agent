 ...
 *
 * The rejection is **HTTP 400, not the 422 the API reference documents**, and its
 * body is `{"detail":{"error_type":"api_usage_error","message":"Invalid request."}}`
 * — it does not name the offending field. Both were measured against the live
 * service. So the captured body below is a diagnostic aid, not the "tells you
 * which field failed" guarantee an earlier version of this comment claimed;
 * reading the request is still the only way to find that out.
 */
